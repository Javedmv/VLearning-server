...
export const addNewUser = async (data: ITOBE) => {
    try {
        ...
        if (existingUser) {
            ...
            const newUserData: ITOBE = { _id: data[0]._id };
        ...
        if (error instanceof Error) {
            ...
            console.error("ERROR IN addNewUser REPOSITORY: Unknown error", error);
        }
    }
